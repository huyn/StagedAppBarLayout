...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = (defStyleAttr == 0)
                ? context.obtainStyledAttributes(attrs, android.support.coreui.R.styleable.CoordinatorLayout,
                    0, android.support.coreui.R.style.Widget_Support_CoordinatorLayout)
                : context.obtainStyledAttributes(attrs, android.support.coreui.R.styleable.CoordinatorLayout,
                    defStyleAttr, 0);
        final int keylineArrayRes = a.getResourceId(android.support.coreui.R.styleable.CoordinatorLayout_keylines, 0);
        ...
        mStatusBarBackground = a.getDrawable(android.support.coreui.R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            final TypedArray a = context.obtainStyledAttributes(attrs,
                    android.support.coreui.R.styleable.CoordinatorLayout_Layout);

            this.gravity = a.getInteger(
                    android.support.coreui.R.styleable.CoordinatorLayout_Layout_android_layout_gravity,
                    Gravity.NO_GRAVITY);
            mAnchorId = a.getResourceId(android.support.coreui.R.styleable.CoordinatorLayout_Layout_layout_anchor,
                    View.NO_ID);
            this.anchorGravity = a.getInteger(
                    android.support.coreui.R.styleable.CoordinatorLayout_Layout_layout_anchorGravity,
                    Gravity.NO_GRAVITY);

            this.keyline = a.getInteger(android.support.coreui.R.styleable.CoordinatorLayout_Layout_layout_keyline,
                    -1);

            insetEdge = a.getInt(android.support.coreui.R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            dodgeInsetEdges = a.getInt(
                    android.support.coreui.R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            mBehaviorResolved = a.hasValue(
                    android.support.coreui.R.styleable.CoordinatorLayout_Layout_layout_behavior);
